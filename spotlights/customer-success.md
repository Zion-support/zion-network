...
- 🗂️ Category page: [Customer Success & Retention](https://github.com/Zion-support/zion-network/blob/main/network/customer-success-ai.md)
- 🌐 Master index: [APPS_NETWORK.md](../APPS_NETWORK.md)
...
- Feed churn signals into outbound saves with the [Sales & Lead Gen suite](sales-leadgen.md)
- MSPs: retention dashboards for every client via the [MSP & Partner Ecosystem](msp-ecosystem.md)
