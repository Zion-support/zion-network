# AI Agents & Autonomous Operations — Zion App Network

Autonomous AI agents that plan, execute and verify multi-step work across IT operations, support, revenue and security. All apps below are free, browser-based tools in the [Zion App Network](https://ziontechgroup.com/apps/) (530+ open-source AI & IT ops apps).

## Flagship agent apps

| App | What it does | Links |
|---|---|---|
| **AI PR Review Swarm** | Swarm of review agents that audit pull requests for security, style and logic | [Live app](https://ziontechgroup.com/ai-pr-review-swarm/) · [Repo](https://github.com/Zion-support/zion-ai-pr-review-swarm) |
| **AI Dispatch Orchestrator** | Autonomous dispatch and routing of tickets to the right agent/team | [Live app](https://ziontechgroup.com/ai-dispatch-orchestrator/) · [Repo](https://github.com/Zion-support/zion-ai-dispatch-orchestrator) |
...
- **Plan → act → verify loops**: every agent logs decisions for auditability
- **Human-in-the-loop gates**: approval thresholds for high-impact actions
- **Composable**: agents share signals through the network (ticket sentinel feeds dispatch orchestrator; churn radar feeds sales copilot)
